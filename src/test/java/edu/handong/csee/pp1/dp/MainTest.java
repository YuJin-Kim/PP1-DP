...
public class MainTest {
	...
	public void testMain() {
		...
		String[] args = {"/Users/yujin/2학년 2학기/실프1/Big data/git/PP1-DP", "data/PP1-DP.arff"}; // for mac users
	...
	@Test
	public void testForGsonProject() {
		...
		//String[] args = {"C:\\Users\\jaech\\git\\PP1-DP","data/PP1-DP.arff"};
		String[] args = {"/Users/yujin/2학년 2학기/실프1/Big data/git/project/gson", "data/gson.arff"}; // for mac users
	...
	@Test
	public void testForJesqueProject() {
		// TASK2 TODO GitHub에서 작은 규모의 자바 프로젝트를 2개를 찾아, arff파일을 생성하시오. 파일이름은 [project이름].arff data디렉터리에 저장되게 하고
		// 생성이 된 후 commit/push해야 함.
		// 위 test main을 참고하여 실행하면 됨.
		//String[] args = {"C:\\Users\\jaech\\git\\PP1-DP","data/PP1-DP.arff"};
		String[] args = {"/Users/yujin/2학년 2학기/실프1/Big data/git/project/jesque", "data/jesque.arff"}; // for mac users
